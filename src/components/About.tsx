    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl pt-16 sm:px-6">
        <div className="bg-zinc-50 pt-px sm:rounded-6xl">
          <div className="relative mx-auto -mt-16 h-44 w-44 flex items-center justify-center overflow-hidden rounded-full bg-indigo-600 md:float-right md:h-64 md:w-64 md:[shape-outside:circle(40%)] lg:mr-20 lg:h-72 lg:w-72">
            <Image
              className="block inset-0 h-2/3 w-2/3 ove"
              src={aboutImage}
              alt=""
