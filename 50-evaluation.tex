...
\begin{figure}[!ht]
    \centering
    \includesvg[width=390pt, keepaspectratio]{Plot_Points}
...
\begin{figure}[!ht]
    \centering
    \includesvg[width=390pt, keepaspectratio]{Plot_Age}
...
\begin{figure}[!ht]
    \centering
    \includesvg[width=390pt, keepaspectratio]{Plot_Platform}
...
Data on the efficiency consisted of 

\todo[inline]{Linear chart with task times.}
\todo[inline]{Stacked chart with task times.}
\todo[inline]{Box plot for the number of confusions.}
...
\todo[inline]{Box plot for SUS with adjectives and grade + \textcite{sauro_practical_2011} percentile rank.}
